...
__ChatGPT has arrived at the North Pole__ and the elf Sam Elfman is working on an application for managing gifts and children.

To enhance the presentation, he wants to create a __function drawTable that receives an array of objects and converts it into a text table__.
